...
public class ActualizarAlumno extends HttpServlet {
    ...
    public void init(ServletConfig scg) throws ServletException{
        //se debe de establecer los elementos para la conexion con bd
        String url = "jdbc:mysql:3036//localhost/alumnos";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                boleta = Integer.parseInt(request.getParameter("boletaA"));
                ...
                String q = "UPDATE alumnobatiz SET "
                        +"nombre ='"+nom+"', "
                        +"appat='"+appat+"', "
                        +"apmat='"+apmat+"', "
                        +"telefono='"+tel+"' "
